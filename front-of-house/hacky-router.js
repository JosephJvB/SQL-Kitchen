...
const TermScreen = ({terminalText, nukeRedux}) => [
    h('div', {key: 'DJ', onClick: nukeRedux, style: {height: '20px', width: '100%', backgroundColor: '#dcdde1', borderRadius: '5px 5px 2px 2px', display: 'flex', flexDirection: 'row', border: '0.5px solid #b3b5be'}}, [
    // red 
  ...
  terminalText,
    ...
    switch(location) {
      case 'HOME': return h('div', {style: {borderRadius: '10px 10px 0 0', width: '80%', margin: 'auto', display: 'flex', flexDirection: 'column', backgroundColor: '#082E38', border: '1px solid #718093'}}, [
        h(TermScreen, {terminalText, nukeRedux}),
        h(Home, {params})
      ])
